    ...
    <nav class="navbar navbar-toggleable-sm fixed-top navbar-light bg-faded">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
            <ul id="cbp-tm-menu" class="cbp-tm-menu">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="#team">Board of Directories</a>
              </li>
              <li class="nav-item">
        ...
        <div class="col-md-10">
          <div class="item active">
            <div class="contents text-center">
              ...
              <img src="{{ asset('user/img/logo-tech-w.png') }}" alt="">
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Technika group is a leading indenting, trading and manufacturing company in Bangladesh.<br> Technika Machinery supplies mechinary products on several fields and has worldwide business affiliations with various world famous foreign manufacturing companies.</p>
