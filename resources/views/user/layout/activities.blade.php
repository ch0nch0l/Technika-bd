...
<section id="services" class="services section">
    <div class="container">
        <div class="section-header">
            <h3 class="section-subtitle wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">Technika Group's</h3>
        ...
        <div class="row activities">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 activity-single">
                <div class="service-box wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="550ms">
                    ...
                    <h3><a href="#">Power Generation</a></h3>
                </div>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 activity-single">
            ...
            <h3><a href="#">Poly Packaging Solution</a></h3>
        </div>
        </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 activity-single">
          ...
          <h3><a href="#">Water Management</a></h3>
        </div>
        </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12 activity-single">
            ...
            <h3><a href="#">Chemical &amp; Mining-tech</a></h3>
        </div>
        </div>
        </div>
